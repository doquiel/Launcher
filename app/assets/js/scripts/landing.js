...
async function loadNewsJson() {
    try {
        var e = new Headers,
            ...
            t = await (await fetch("http://nebula.fraternidadegamer.com.br/news.json", a)).json();
        news_slider.innerHTML = "";
        for (const n of t) {
            let e = "";
             news_slider.innerHTML += `
                <div class="frontContainer" style="display: flex">
                    <img class="frontImage" src="${n.frontIMG||"./assets/images/render2.png"}">
                    ${e}
                </div>
                <div class="newsContainer" style="display: flex">
                <img class="newsImage" src="${n.newsIMG||"./assets/images/render2.png"}">
                ${e}
            </div>
